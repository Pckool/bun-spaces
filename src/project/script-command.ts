...
const METHODS: Record<ScriptCommandMethod, (options: CreateScriptCommandOptions) => ScriptCommand> = {
...
export const createScriptCommand = (options: CreateScriptCommandOptions) => METHODS[options.method](options);
