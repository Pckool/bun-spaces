...
export const LIBRARY_CONSUMER_BUN_VERSION = rootPackageJson.custom.bunVersion.libraryConsumer;

export const BUILD_BUN_VERSION = rootPackageJson.custom.bunVersion.build;

export const getRequiredBunVersion = (build?: boolean) => (build ? BUILD_BUN_VERSION : LIBRARY_CONSUMER_BUN_VERSION);
 ...
 */
export const validateCurrentBunVersion = (build?: boolean) => validateBunVersion(Bun.version, build);
